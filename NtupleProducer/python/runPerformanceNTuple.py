...
def saveCands():
    ...
    # monitorPerf("L1PF", "l1tLayer1:PF", makeResp=False, makeRespSplit=False, makeJets=False, makeMET=False, makeCentralMET=False,
    #             makeInputMultiplicities=False, makeOutputMultiplicities=False, saveCands=True)
    monitorPerf("L1Puppi", "l1tLayer1:Puppi", makeResp=False, makeRespSplit=False, makeJets=False, makeMET=False, makeCentralMET=False,
                makeInputMultiplicities=False, makeOutputMultiplicities=False, saveCands=True)
